...
_Generated at: 2026-09-21T07:27:19.528Z_
...
| WEB | 14 | 22 | 23 | 1.6 |
| **Total** | **152** | **292** | **314** | **2.1** |

## Execution status

69 real execution record(s) across 66 test case(s). A test case with no execution record stays `Not Executed`; where a case has been run more than once, the most recent record wins.
...
| WEB | 3 | 0 | 1 | 19 | 0 |
| **Total** | **165** | **24** | **55** | **69** | **1** |

Automated: 53% of all test cases.
