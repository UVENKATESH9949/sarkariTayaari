/**
 * The mobile mirror of backend/.../evaluation/{QuestionEvaluator,SingleChoiceEvaluator,
 ...
 * asserted on the Java side by QuestionEvaluatorsTest. This project has no test runner
 * configured (no jest/vitest — confirmed by grepping package.json), so this copy is
 * verified by reading and by tracing those same cases by hand, exactly as that fixture
 * file's own comment states — not implied, not skipped silently.
 */
