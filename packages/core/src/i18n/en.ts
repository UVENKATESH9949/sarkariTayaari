...
export const en = {
  ...
  practice: {
    ...
    sessionSize: "{count} questions each session",
    freshEverySession: "new questions every time",
    mixedDifficulty: "Mixed difficulty",
    topicCoverage: "{done}/{total} · {percent}%",
    browseSubtitle: "Choose a subject and start practicing",
    searchSubjectsOrTopics: "Search subjects or topics...",
    ...
    closeLevelPicker: "Close difficulty picker",
  ...
  quiz: {
    ...
    orderingPlaceholder: "Tap items below to build your answer.",
