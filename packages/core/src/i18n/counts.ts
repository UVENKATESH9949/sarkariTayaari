 ...
 * bodies and other non-component code — which is also what lets it live here, outside any
 * app's React tree. Pluralisation is two catalogue keys rather than a CLDR rules engine —
