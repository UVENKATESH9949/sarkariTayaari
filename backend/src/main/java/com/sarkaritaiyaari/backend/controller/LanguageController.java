...
public class LanguageController {
    ...
    public LanguageController(LanguageService languageService, AuthService authService) {
        this.languageService = languageService;
        this.authService = authService;
    }

    @PostMapping
    public ResponseEntity<LanguageResponse> create(@RequestHeader(HttpHeaders.AUTHORIZATION) String authorization,
    ...
    /** Active-only — this is the mobile-facing list. Deliberately public. */
    @GetMapping
    ...
    @GetMapping("/all")
    public List<LanguageResponse> listAll(@RequestHeader(HttpHeaders.AUTHORIZATION) String authorization) {
        authService.requireAdmin(authorization);
        return languageService.listAll();
    }

    @PutMapping("/{code}")
    public LanguageResponse update(@RequestHeader(HttpHeaders.AUTHORIZATION) String authorization,
                                    @PathVariable String code, @Valid @RequestBody LanguageRequest request) {
        authService.requireAdmin(authorization);
