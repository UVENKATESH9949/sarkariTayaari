...
This folder is the project's own persistent memory — living documentation meant to travel with the repo, readable by any developer or any future AI session picking up this work.

- **`STATUS.md`** — always the first thing to read. Current state, exact resume point, immediate next step, known environment gotchas. Update this whenever work pauses.
